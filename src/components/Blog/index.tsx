	...
	const posts = [
		{
			...
			author: "Oni Emma",
			date: "Nov 15, 2023",
			title: "Culinary Tour: Epicurean Excursions",
			description: "Embark on a global culinary adventure from street markets to Michelin-starred restaurants.",
		},
		{
			image: postImage2,
			author: "Amin Najva",
			date: "Nov 15, 2023",
			title: "In-Flight Relaxation: Skyward Serenity",
			description: "Turn your flight into a serene journey with our tips for relaxation at 30,000 feet.",
		},
		{
			image: postImage3,
			author: "Johnson Stan",
			...
			description: "Discover unique destinations, unlocking an extraordinary travel experience.",
		},
	];
	...
	return (
		<div className="flex w-full pb-20 md:px-[200px] px-8 flex-col gap-16 justify-center items-center">
			<div className="flex flex-col w-full items-center">
				...
				Explore these captivating stories and more on our blog. 
				Gain travel tips, destination guides, and unique insights to inspire your next adventure.
				</p>
			</div>
				...
				{posts.map((post) => {
					return (
						...
						>
							...
							<div className="font-medium text-blue-600 px-4 py-3 cursor-pointer  hover:bg-white hover:text-blue-400">
								Read More
							</div>
						</div>
					);
