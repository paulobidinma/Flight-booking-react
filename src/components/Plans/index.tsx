...
const Plans = () => {
	const plansList = [
		...
		{ title: "Medical Chopper", image: plan2, code: "Charter S4632", price: "180" },
		{ title: "Private Plane(single) ", image: plan3, code: "Charter B1732", price: "200" },
	];
	return (
		<div className="flex w-full pt-5 pb-20 md:px-[200px] px-8 flex-col gap-16 justify-center items-center">
			<div className="flex flex-col w-full items-center">
				...
				Discover personalized travel with Luxury Flights. 
				Tailored to your needs, our exclusive plans redefine the way you journey.
				</p>
			</div>
					...
					return (
						...
						>
							...
							<div className="w-full px-4">
								<button className="mt-5 mb-3 flex gap-3 border-[2px] bg-blue-400 border-blue-400 px-5 py-2 text-white font-semibold rounded-full  hover:bg-white hover:text-blue-400">
									<AirplaneOutline color="#fff  hover:bg-white hover:text-blue-400" />
									Book Now
								</button>
							</div>
						</div>
